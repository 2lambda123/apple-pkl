...
* In other cases, type inference fails with the error message "Cannot tell which parent to amend".

The type information of a <<methods,method>> parameter is not used for type inference.
In this case, argument type information should be specified explicitly.
